...
const noAndYesKeyboard = Markup.inlineKeyboard([Markup.button.callback('нет', 'exit'), Markup.button.callback('Да', 'yes')]);
...
export {
  exitKey, backAndExitKeyboard, timeRangeKeyboard, controlChalKeyboard, noAndYesKeyboard,
};
